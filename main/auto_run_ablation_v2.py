...
def create_output_dirs(project_dir, entry_functions):
    ...
    output_dir = f"output_v2/{repo_name}"
...
def ablation_without_static_analysis_process(project_dir,entry_functions, output_dir,depth):
    ...
    merge_results_without_static_analysis(entry_functions, output_dir)
...
def main():
    ...
    ablation_without_static_analysis_process(project_dir,entry_functions, output_dir,depth)
